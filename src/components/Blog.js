    ...
    return (
        <div className="blog">
            ...
            <div className="section china">
                ...
                The World Health Organization declared the outbreak a "Public Health Emergency of International Concern" on 31 January, citing reasons of spread in other countries, particularly those without robust healthcare systems.
